...
We can define these prefixes in the store with the following code,
the first prefix in the full syntax and the other namespaces
leaving out the parameters names:
...
Or output is as a Notation3 string with:
