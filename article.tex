...
The RJava libary and a custom convenience class is used to bridge between R and the Jena library.\\
...
Affero GNU Public Licence version 3: \url{http://cran.r-project.org/web/packages/rrdf/}.
\end{abstract}
