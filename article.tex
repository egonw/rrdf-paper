...
applicable. It currently only exposes a subset of key Apache Jena is exposed, but the framework
makes it easy to make more of the library's functionality available.
